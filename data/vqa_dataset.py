...
def choice_vqa_collate_fn(batch):
    image_list, question_list, answer_list, labels = [], [], [], []
    for image, question, answers, label in batch:
        image_list.append(image)
        question_list.append(question)
        answer_list.append(answers)
        labels.append(label)
    return torch.stack(image_list, dim=0), question_list, answer_list, labels
